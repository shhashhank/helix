...
flowchart TB
  ...
  subgraph lib["Shared libraries — @helix/*"]
    ...
    pl["@helix/planning<br/>Planning Agent<br/>requirement extraction → spec<br/>ambiguity detection (confidence) · clarification loop<br/>task decomposition → validated DAG + waves"]
  end
