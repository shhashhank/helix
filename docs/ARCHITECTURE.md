...
flowchart TB
  ...
  subgraph lib["Shared libraries — @helix/*"]
    ...
    cag["@helix/coding-agent<br/>Coding Agent<br/>file edit tools (read/write/patch in sandbox)<br/>scaffold generators · NestJS CRUD exemplar<br/>workspace diff · commit grouping"]
  end
